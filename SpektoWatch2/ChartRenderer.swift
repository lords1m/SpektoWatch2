...
enum ChartRenderer {
    static func drawLineChart(
        ...
        context.saveGState()
        let plotRect = drawAxisGrid(in: context, rect: rect, niceMin: niceMin, niceMax: niceMax)
    ...
    /// Shared horizontal grid, left-axis tick labels, and L-shaped plot border.
    /// Returns the inner plot rect for series rendering.
    private static func drawAxisGrid(
        in context: CGContext,
        rect: CGRect,
        niceMin: Double,
        niceMax: Double
